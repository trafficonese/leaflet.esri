...
checker.init(
  ...
  function(err, license_json) {
    ...
    console.log("The leaflet.esri package as a whole is distributed under GPL-3 (GNU GENERAL PUBLIC LICENSE version 3).\n\nThe leaflet.esri package includes other open source software components. The following\nis a list of these components (full copies of the license agreements used by\nthese components are included below):");
    console.log("");
